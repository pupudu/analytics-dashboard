 ...
 */
            ...
            /**
            *  GetDataViews bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDataViews
    ...
    public static class Factory{
        ...
        */
        public static GetDataViews parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDataViews object =
                new GetDataViews();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDataViews".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDataViews)org.wso2.carbon.analytics.dashboard.admin.data.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
